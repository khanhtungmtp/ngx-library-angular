/*
 * Public API Surface of ngx-dropzone-alt
 */

// export * from './lib/ngx-dropzone-alt.service';
export * from './lib/ngx-dropzone-alt.component';
export * from './lib/ngx-dropzone-alt.module';
